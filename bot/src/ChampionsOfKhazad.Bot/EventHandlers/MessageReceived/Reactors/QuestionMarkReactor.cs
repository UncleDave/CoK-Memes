...
public class QuestionMarkReactor(IOptions<QuestionMarkReactorOptions> options) : GuildMessageReactor(new GuildMessageReactorOptions(options.Value.UserId, new[] { new Emoji("❔"), new Emoji("❓") }))
{
