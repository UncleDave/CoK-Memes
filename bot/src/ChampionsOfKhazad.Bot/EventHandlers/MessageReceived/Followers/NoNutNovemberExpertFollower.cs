...
public class NoNutNovemberExpertFollower(IOptions<AllFollowersOptions> allFollowersOptions,
        IOptions<NoNutNovemberExpertFollowerOptions> options,
        Assistant assistant,
        BotContext botContext,
        ILogger<NoNutNovemberExpertFollower> logger)
    : RandomChanceTriggerWordsFollower(new RandomChanceTriggerWordFollowerOptions(
